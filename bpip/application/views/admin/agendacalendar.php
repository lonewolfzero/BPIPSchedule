...
<div class="box-header" bis_skin_checked="1">
	<h3 class="box-title">Kelola Data Agenda Calendar </h3>
</div>
...
<div class="box-body" bis_skin_checked="1">
	...
	<div style="padding-bottom: 10px;" '="" bis_skin_checked="1">
		<?php echo anchor(site_url('agenda/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-success btn-sm"'); ?>
		<?php echo anchor(site_url('agenda/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?>
