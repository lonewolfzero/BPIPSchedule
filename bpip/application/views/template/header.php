    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
				<li><a href="<?= base_url('agenda/agendacalendar'); ?>"><i class="fa fa-circle-o"></i> Agenda Calendar</a></li>
				<li><a href="<?= base_url('agenda/index'); ?>"><i class="fa fa-circle-o"></i> Agenda Kegiatan</a></li>
          </ul>
        </li>   
